...
## 13. Research Paper & Citation

This project is based on research published at the **NIPS 2018 Workshop on Machine Learning for Intelligent Transportation Systems (MLITS)**:

> [Deep Reinforcement Learning for Intelligent Transportation Systems](https://openreview.net/forum?id=BJl846ey97)

If you use this repository for academic work, research, or any project, please cite:
...
Contributions, improvements, and extensions are welcome! Here are some ideas for what could be built on top of this project:

- **Real map integration**: Connect to OpenStreetMap road network data
- **More realistic arrival models**: Use Poisson distributions for car arrivals
- **Pedestrian modeling**: Add pedestrian crossing signals as part of the state
- **Transfer learning**: Pre-train on simple intersections, then fine-tune on complex grids
- **Multi-agent communication**: Let agents explicitly share queue information with neighbors
- **Better visualization**: Add real-time reward plotting alongside the simulation
...
<p align="center">
  Built with ❤️ using Deep Reinforcement Learning<br>
  <a href="https://openreview.net/forum?id=BJl846ey97">Research Paper</a> •
  <a href="PROJECT_DETAILS.md">Theoretical Deep-Dive</a> •
